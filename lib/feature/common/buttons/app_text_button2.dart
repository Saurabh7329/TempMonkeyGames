...
class AppTextButton2 extends StatelessWidget {
  ...
  const AppTextButton2({Key? key, required this.function, required this.text, this.style}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return TextButton(
        ...
        onPressed: () => function(),
        child: Text(text,
            style: style?.copyWith(color: AppColors.whities) ?? AppTextStyle.body.copyWith(
